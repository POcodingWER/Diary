...
(function () {
  ...
  var demoContent = [
    {
      demo_link:
        "https://pocodingwer.github.io/POcodingWER_Blog/pics/animation/reactNativeAnimation.html",
      img_link:
        "https://cdn.jsdelivr.net/gh/Gaohaoyang/pics/pics/demos/animationInReactNative.png",
    ...
    {
      demo_link:
        "https://pocodingwer.github.io/POcodingWER_Blog/threeJourney/23-rose/",
      img_link: "https://cdn.jsdelivr.net/gh/Gaohaoyang/pics/pics/3d_rose.gif",
      code_link:
        "https://github.com/Gaohaoyang/threeJourney/tree/main/src/23-rose",
      title: "Three.js render 3D Rose",
      core_tech: "Three.js WebGL",
      description:
        "On the 5th anniversary, I use Three.js to render a rose for my wife.",
    },
    {
      demo_link:
        "https://pocodingwer.github.io/POcodingWER_Blog/demos/#/FerrisWheel",
      img_link:
        "https://cdn.jsdelivr.net/gh/Gaohaoyang/pics/pics/demos/ferrisWheel.gif",
      code_link:
        "https://github.com/Gaohaoyang/demos/tree/main/src/FerrisWheel",
      title: "Ferris Wheel",
      core_tech: "anime.js",
      description:
        'A Ferris Wheel animation with anime.js. You can change the speed and direction. See blog <a href="https://pocodingwer.github.io/POcodingWER_Blog/2022/10/15/ferris-wheel/">here</a>.',
    },
    {
      demo_link: "https://pocodingwer.github.io/POcodingWER_Blog/lottie-test/",
      img_link:
        "https://cdn.jsdelivr.net/gh/Gaohaoyang/pics/pics/demos/lottieDemo.gif",
    ...
    },
    {
      ...
      img_link:
        "https://cdn.jsdelivr.net/gh/Gaohaoyang/pics/pics/demos/lifeProgress.png",
    ...
    },
    {
      ...
      description:
        'Fisher-Yates 洗牌算法动画。算法详情见 <a href ="https://pocodingwer.github.io/POcodingWER_Blog/2016/10/16/shuffle-algorithm/">这里</a>。',
    },
    {
      demo_link: "http://gaohaoyang.github.io/test/headerTransition/",
      img_link: "https://ooo.0o0.ooo/2016/06/20/5768c1597d1fe.png",
      code_link:
        "https://github.com/Gaohaoyang/test/tree/master/headerTransition",
    ...
    },
    {
      ...
      description:
        "使用 animate 方法，做到兼容 IE8。曾在联想服务官网上线3个月。",
    },
    {
    ...
    },
    {
      ...
      code_link:
        "https://github.com/Gaohaoyang/baidu-ife-practice/tree/master/task0003",
    ...
    {
      demo_link:
        "http://gaohaoyang.github.io/ife/task/task0002/work/Gaohaoyang/task0002_5.html",
      img_link: "http://7q5cdt.com1.z0.glb.clouddn.com/demo-drag.png",
      code_link:
        "https://github.com/Gaohaoyang/ife/tree/master/task/task0002/work/Gaohaoyang",
      title: "拖拽交互",
      core_tech: "JavaScript",
    ...
    {
      demo_link:
        "http://gaohaoyang.github.io/ife/task/task0002/work/Gaohaoyang/task0002_4.html",
      img_link:
        "http://ww2.sinaimg.cn/large/7011d6cfjw1f3ba2krzs0j207005y0sv.jpg",
      code_link:
        "https://github.com/Gaohaoyang/ife/tree/master/task/task0002/work/Gaohaoyang",
      title: "输入框即时提示",
      core_tech: "JavaScript",
    ...
    {
      demo_link:
        "http://gaohaoyang.github.io/ife/task/task0002/work/Gaohaoyang/task0002_3.html",
      img_link:
        "http://ww2.sinaimg.cn/large/7011d6cfjw1f3ba04okoqj20eq093wh1.jpg",
      code_link:
        "https://github.com/Gaohaoyang/ife/tree/master/task/task0002/work/Gaohaoyang",
      title: "轮播图",
      core_tech: "JavaScript",
    ...
    {
      demo_link:
        "http://gaohaoyang.github.io/ife/task/task0002/work/Gaohaoyang/task0002_2.html",
      img_link:
        "http://ww4.sinaimg.cn/large/7011d6cfjw1f3b9w6xpz5j20ae02pgm3.jpg",
      code_link:
        "https://github.com/Gaohaoyang/ife/tree/master/task/task0002/work/Gaohaoyang",
      title: "倒计时",
      core_tech: "JavaScript",
    ...
    {
      demo_link:
        "http://gaohaoyang.github.io/ife/task/task0002/work/Gaohaoyang/task0002_1.html",
      img_link:
        "http://ww3.sinaimg.cn/large/7011d6cfjw1f3b9tmyuh2j20au0aaaar.jpg",
      code_link:
        "https://github.com/Gaohaoyang/ife/tree/master/task/task0002/work/Gaohaoyang",
      title: "处理兴趣爱好列表",
      core_tech: "JavaScript",
    ...
    {
      demo_link:
        "http://gaohaoyang.github.io/ife/task/task0002/work/Gaohaoyang/index.html",
    ...
    {
      demo_link:
        "http://gaohaoyang.github.io/ife/task/task0001/work/Gaohaoyang/index.html",
      img_link: "http://7q5cdt.com1.z0.glb.clouddn.com/Demo-blog-ife.jpg",
      code_link:
        "https://github.com/Gaohaoyang/ife/tree/master/task/task0001/work/Gaohaoyang",
    ...
    },
    {
      ...
      core_tech: "CSS3",
      description:
        "使用 CSS3 中的旋转、缩放、过渡、动画等效果，制作出很酷的按钮效果。",
    },
    {
    ...
    {
      demo_link:
        "http://gaohaoyang.github.io/learning-AngularJS/2-3-bookstore-add-sth-by-myself/",
      ...
      description:
        "使用 AngularJS 中的 ngAnimate 加 CSS3里面的一些旋转效果，做出页面切换的效果。",
    },
    {
      demo_link:
        "http://gaohaoyang.github.io/learning-AngularJS/2-4-UiRouterPractice",
      img_link:
        "http://ww2.sinaimg.cn/large/7011d6cfjw1f3b8zumfqij20q40nh76x.jpg",
      code_link:
    ...
    },
    {
      ...
      img_link:
        "http://7q5cdt.com1.z0.glb.clouddn.com/teach-girlfriend-html-CopyZhihu.jpg",
      code_link:
        "https://github.com/Gaohaoyang/test/tree/master/bootstrap-zhihu",
      title: "仿知乎页面",
...
function contentInit(content) {
  ...
  for (var i = 0; i < content.length; i++) {
    ...
    if (content[i].img_link) {
      htmlArr.push(
        '<img src="' + content[i].img_link + '" style="width: 100%">'
      );
    }
    htmlArr.push("</a>");
    ...
    if (content[i].code_link) {
      htmlArr.push(
        '<a href="' +
          content[i].code_link +
          '"> Source code <i class="fa fa-code" aria-hidden="true"></i></a>'
      );
    }
    htmlArr.push("</p>");
    htmlArr.push("</div>");
